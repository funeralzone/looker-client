...
class MergeQuerySourceQuery implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'merge_fields' => '\Funeralzone\LookerClient\Model\MergeFields[]',
        'name' => 'string',
        'query_id' => 'int'
    ];
     ...
     * Gets merge_fields
     *
     * @return \Funeralzone\LookerClient\Model\MergeFields[]
     */
     ...
     * Sets merge_fields
     *
     * @param \Funeralzone\LookerClient\Model\MergeFields[] $merge_fields An array defining which fields of the source query are mapped onto fields of the merge query
     *
     * @return $this
     */
