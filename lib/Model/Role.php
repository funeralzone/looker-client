...
class Role implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'id' => 'int',
        'name' => 'string',
        'permission_set' => '\Funeralzone\LookerClient\Model\PermissionSet',
        'permission_set_id' => 'int',
        'model_set' => '\Funeralzone\LookerClient\Model\ModelSet',
        'model_set_id' => 'int',
        'url' => 'string',
        'users_url' => 'string',
        'can' => 'map[string,bool]'
     ...
     * Sets permission_set
     *
     * @param \Funeralzone\LookerClient\Model\PermissionSet $permission_set (Read only) Permission set
     *
     * @return $this
     */
     ...
     * Sets model_set
     *
     * @param \Funeralzone\LookerClient\Model\ModelSet $model_set (Read only) Model set
     *
     * @return $this
     */
