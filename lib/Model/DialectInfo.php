...
class DialectInfo implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'name' => 'string',
        'supported_options' => '\Funeralzone\LookerClient\Model\DialectInfoOptions',
        'can' => 'map[string,bool]'
    ];
     ...
     *
     * @return \Funeralzone\LookerClient\Model\DialectInfoOptions
     */
     ...
     *
     * @param \Funeralzone\LookerClient\Model\DialectInfoOptions $supported_options Option support details
     *
     * @return $this
     */
