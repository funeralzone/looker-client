...
class LookmlModel implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'explores' => '\Funeralzone\LookerClient\Model\LookmlModelNavExplore[]',
        'has_content' => 'bool',
        'label' => 'string',
        'name' => 'string',
        'project_name' => 'string',
     ...
     * Gets explores
     *
     * @return \Funeralzone\LookerClient\Model\LookmlModelNavExplore[]
     */
     ...
     * Sets explores
     *
     * @param \Funeralzone\LookerClient\Model\LookmlModelNavExplore[] $explores Array of explores (if has_content)
     *
     * @return $this
     */
