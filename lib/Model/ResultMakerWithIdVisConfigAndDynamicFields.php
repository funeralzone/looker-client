...
class ResultMakerWithIdVisConfigAndDynamicFields implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'filterables' => '\Funeralzone\LookerClient\Model\ResultMakerFilterables[]',
        'sorts' => 'string',
     ...
     * Gets filterables
     *
     * @return \Funeralzone\LookerClient\Model\ResultMakerFilterables[]
     */
     ...
     * Sets filterables
     *
     * @param \Funeralzone\LookerClient\Model\ResultMakerFilterables[] $filterables array of items that can be filtered and information about them.
     *
     * @return $this
     */
