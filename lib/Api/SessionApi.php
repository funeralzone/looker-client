...
class SessionApi
{
     ...
     * @return \Funeralzone\LookerClient\Model\ApiSession
     */
     ...
     * @throws \Funeralzone\LookerClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Funeralzone\LookerClient\Model\ApiSession, HTTP status code, HTTP response headers (array of strings)
     */
    public function sessionWithHttpInfo()
    {
        $returnType = '\Funeralzone\LookerClient\Model\ApiSession';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Funeralzone\LookerClient\Model\ApiSession',
     ...
     * Update Session
     *
     * @param  \Funeralzone\LookerClient\Model\ApiSession $body Session (required)
     *
     * @throws \Funeralzone\LookerClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Funeralzone\LookerClient\Model\ApiSession
