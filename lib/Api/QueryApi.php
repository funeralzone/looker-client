...
class QueryApi
{
     ...
     * @return \Funeralzone\LookerClient\Model\RunningQueries[]
     */
     ...
     * @throws \Funeralzone\LookerClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Funeralzone\LookerClient\Model\RunningQueries[], HTTP status code, HTTP response headers (array of strings)
     */
    public function allRunningQueriesWithHttpInfo()
    {
        $returnType = '\Funeralzone\LookerClient\Model\RunningQueries[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Funeralzone\LookerClient\Model\RunningQueries[]',
     ...
     * Create Merge Query
     *
     * @param  \Funeralzone\LookerClient\Model\MergeQuery $body Merge Query (optional)
     * @param  string $fields Requested fields (optional)
     *
     * @throws \Funeralzone\LookerClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Funeralzone\LookerClient\Model\MergeQuery
     */
     ...
     * @throws \Funeralzone\LookerClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Funeralzone\LookerClient\Model\MergeQuery, HTTP status code, HTTP response headers (array of strings)
     */
    public function createMergeQueryWithHttpInfo($body = null, $fields = null)
    {
        $returnType = '\Funeralzone\LookerClient\Model\MergeQuery';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Funeralzone\LookerClient\Model\MergeQuery',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * Create Query
     *
     * @param  \Funeralzone\LookerClient\Model\Query $body Query (optional)
     * @param  string $fields Requested fields. (optional)
     *
     * @throws \Funeralzone\LookerClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @throws \Funeralzone\LookerClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Funeralzone\LookerClient\Model\Query, HTTP status code, HTTP response headers (array of strings)
     */
    public function createQueryWithHttpInfo($body = null, $fields = null)
    {
        $returnType = '\Funeralzone\LookerClient\Model\Query';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Funeralzone\LookerClient\Model\Query',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * Run Query Async
     *
     * @param  \Funeralzone\LookerClient\Model\CreateQueryTask $body Query parameters (required)
     ...
     * @throws \Funeralzone\LookerClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Funeralzone\LookerClient\Model\QueryTask
     */
     ...
     * @throws \Funeralzone\LookerClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Funeralzone\LookerClient\Model\QueryTask, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Funeralzone\LookerClient\Model\QueryTask';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Funeralzone\LookerClient\Model\QueryTask',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \Funeralzone\LookerClient\Model\SqlQueryCreate $body SQL Runner Query (required)
     *
     * @throws \Funeralzone\LookerClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @throws \Funeralzone\LookerClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Funeralzone\LookerClient\Model\SqlQuery, HTTP status code, HTTP response headers (array of strings)
     */
    public function createSqlQueryWithHttpInfo($body)
    {
        $returnType = '\Funeralzone\LookerClient\Model\SqlQuery';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Funeralzone\LookerClient\Model\SqlQuery',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  \Funeralzone\LookerClient\Model\Query $body inline query (required)
     * @param  int $limit Row limit (may override the limit in the saved query). (optional)
     * @param  bool $apply_formatting Apply model-specified formatting to each result. (optional)
     * @param  bool $apply_vis Apply visualization options to results. (optional)
     * @param  bool $cache Get results from cache if available. (optional)
     ...
     *
     * @param  string $slug slug of query (required)
     * @param  string $result_format Format of result, options are: [\&quot;json\&quot;, \&quot;json_detail\&quot;, \&quot;json_fe\&quot;, \&quot;csv\&quot;, \&quot;html\&quot;, \&quot;md\&quot;, \&quot;txt\&quot;, \&quot;xlsx\&quot;, \&quot;gsxml\&quot;, \&quot;json_label\&quot;] (required)
