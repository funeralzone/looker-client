...
class ApiAuthApi
{
     ...
     * @return \Funeralzone\LookerClient\Model\AccessToken
     */
     ...
     * @throws \Funeralzone\LookerClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Funeralzone\LookerClient\Model\AccessToken, HTTP status code, HTTP response headers (array of strings)
     */
    public function loginWithHttpInfo($client_id = null, $client_secret = null)
    {
        $returnType = '\Funeralzone\LookerClient\Model\AccessToken';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Funeralzone\LookerClient\Model\AccessToken',
